...
Shader "WorldMap/Elevation"
{
        ...
        SubShader
    {
        ...
        void surf(Input IN, inout SurfaceOutput o)
        {
            ...
            o.Alpha = (1);
            half4 Color = half4(1, 0.6, 0, 1);

            float value = max(0, TrueHeight / HeightTranslator(1));
            float shadeValue = 1.0f;

            if (TrueWarterBiomePresence >= 0.5 || TrueHeight < 0) {
                value = max(0, (1 - TrueHeight) / HeightTranslator(1));
                Color = half4(0, 0, 1, 1);
            }
            if (TrueIcedScore > 0.8) {
                Color = half4(1, 1, 1, 1);
            }
            ...
            o.Albedo = half4(Color.r * shadeValue, Color.g * shadeValue, Color.b * shadeValue, 1);
