...
public class NotEqualsExpression<T> : BinaryOpExpressionWithOutput<bool> where T : IComparable<T>
{
    private readonly IValueExpression<T> _valueExpressionA;
    private readonly IValueExpression<T> _valueExpressionB;

    public NotEqualsExpression(IExpression expressionA, IExpression expressionB) :
