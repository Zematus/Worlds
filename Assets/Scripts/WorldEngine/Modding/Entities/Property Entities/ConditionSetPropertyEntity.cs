...
public class ConditionSetPropertyEntity : PropertyEntity
{
    ...
    private class ConditionSetValueAttribute : BooleanEntityAttribute
    {
        private ConditionSetPropertyEntity _propertyEntity;

        public ConditionSetValueAttribute(ConditionSetPropertyEntity propertyEntity)
    ...
    public override EntityAttribute GetAttribute(string attributeId, IExpression[] arguments = null)
    {
        switch (attributeId)
        {
            case ValueId:
                _valueAttribute =
                    _valueAttribute ??
                    new ConditionSetValueAttribute(this);
