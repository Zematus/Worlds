...
public class Element
{
    ...
    public static Element Rain = new Element("Rain", "rain:s",
        ...
        new string[] { "rainfall_above:675" },
        new string[] { "[iv(bear,ts,past)]born,under,u|ns", "[iv(bear,ts,past)]born,between,ip", "[rv(ts,past)]bath:ed,by,u", "[rv(ts,past)]soak:ed,by,u", "[rv(ts,past)]drench:ed,by,u", "[nrv]dance:r" });
