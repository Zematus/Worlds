...
public class PolityCulture2 : Culture
{
    ...
    private void ResetAttributeValues()
    {
        ...
        foreach (PolityCulturalKnowledge knowledge in Knowledges.Values)
        {
            knowledge.AggregateValue = 0;
            knowledge.Value = 0;
        }

        foreach (PolityCulturalDiscovery discovery in Discoveries.Values)
        {
    ...
    private void AddGroupCulture(CellGroup group)
    {
        ...
        foreach (CulturalPreference groupPreference in group.Culture.Preferences.Values)
        {
        ...
        foreach (CulturalActivity groupActivity in group.Culture.Activities.Values)
        {
        ...
        foreach (CulturalSkill groupSkill in group.Culture.Skills.Values)
        {
        ...
        foreach (CulturalKnowledge groupKnowledge in group.Culture.Knowledges.Values)
        {
        ...
        foreach (CulturalDiscovery groupDiscovery in group.Culture.Discoveries.Values)
        {
